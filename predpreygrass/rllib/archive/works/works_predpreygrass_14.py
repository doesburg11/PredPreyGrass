...
class PredPreyGrass(MultiAgentEnv):
    def __init__(self, config=None):
        ...
        self.max_num_grass: int = 25
        self.initial_num_grass: int = 25
        self.current_num_grass: int = 25
        ...
        # Spaces
        self.predator_obs_range = 7  # Larger range for predators
        self.prey_obs_range = 5  # Smaller range for prey

        self.predator_obs_offset = (self.predator_obs_range - 1) // 2
        self.prey_obs_offset = (self.prey_obs_range - 1) // 2


        self.num_obs_channels = 4  # Border, Predator, Prey, Grass
