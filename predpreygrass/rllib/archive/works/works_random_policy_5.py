...
from works_predpreygrass_5 import PredPreyGrass  # Import your custom environment
...
if __name__ == "__main__":
    ...
    for step in range(env.max_steps):  # Arbitrary large number to test termination
        ...
        # Debug information
        print(f"Number of predators left: {env.current_num_predators}")
        print(f"Number of prey left: {env.current_num_prey}")
        print(f"Number of agents left: {env.num_agents}")
        print(f"Number of grass left: {env.current_num_grass}")
        print("-----------------------------------------")
