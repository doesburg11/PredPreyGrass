from predpreygrass.rllib.v0_neumann.predpreygrass_rllib_env import PredPreyGrass  # Import the custom environment
...
checkpoint_path = f"file://{os.path.abspath('./predpreygrass/rllib/v0_neumann/trained_model/PPO_PredPreyGrass_fc60b_00000_0_2025-03-20_15-16-59/checkpoint_000029')}"
