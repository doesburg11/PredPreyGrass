...
from predpreygrass.stag_hunt_forward_view_nature_nurture.config.config_env_stag_hunt_forward_view import config_env
from predpreygrass.stag_hunt_forward_view_nature_nurture.utils.episode_return_callback import EpisodeReturn
from predpreygrass.stag_hunt_forward_view_nature_nurture.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.stag_hunt_forward_view_nature_nurture.config.config_ppo_gpu_stag_hunt_forward_view import config_ppo
    elif num_cpus == 8:
        from predpreygrass.stag_hunt_forward_view_nature_nurture.config.config_ppo_cpu_stag_hunt_forward_view import config_ppo
    else:
