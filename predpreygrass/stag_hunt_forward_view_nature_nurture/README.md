...
`predpreygrass.stag_hunt_forward_view_nature_nurture.*`
...
```bash
PYTHONPATH=src python -m predpreygrass.stag_hunt_forward_view_nature_nurture.utils.defection_metrics
```
...
Log source: `predpreygrass/stag_hunt_forward_view_nature_nurture/ray_results/join_cost_0.02/STAG_HUNT_FORWARD_VIEW_JOIN_COST_0_02_SCAVENGER_0_3_2026-01-29_15-52-24/PPO_PredPreyGrass_1fe3e_00000_0_2026-01-29_15-52-25/checkpoint_000099/eval_10_runs_STAG_HUNT_FORWARD_VIEW_2026-02-04_23-06-13/summary_data/agent_event_log_1.json`
...
- Train: `python predpreygrass/stag_hunt_forward_view_nature_nurture/tune_ppo.py`
- Random rollouts: `python predpreygrass/stag_hunt_forward_view_nature_nurture/random_policy.py`
...
```bash
# Train
PYTHONPATH=src python predpreygrass/stag_hunt_forward_view_nature_nurture/tune_ppo.py

# Random rollout viewer
PYTHONPATH=src python predpreygrass/stag_hunt_forward_view_nature_nurture/random_policy.py

# Evaluate a checkpoint (debug viewer)
PYTHONPATH=src python predpreygrass/stag_hunt_forward_view_nature_nurture/evaluate_ppo_from_checkpoint_debug.py

# Evaluate multiple runs (batch)
PYTHONPATH=src python predpreygrass/stag_hunt_forward_view_nature_nurture/evaluate_ppo_from_checkpoint_multi_runs.py
```
...
```bash
PYTHONPATH=src python -m predpreygrass.stag_hunt_forward_view_nature_nurture.utils.sweep_nature_weight_ablation \
  --runs 10 \
  --steps 1000 \
