...
```bash
python predpreygrass/centralized_training/tune_ppo_centralized_training.py
```
Notes:
...
```bash
python predpreygrass/centralized_training/evaluate_ppo_from_checkpoint_debug.py
```
or the default variant:
```bash
python predpreygrass/centralized_training/evaluate_ppo_from_checkpoint_default.py
```
For sweeping multiple runs:
```bash
python predpreygrass/centralized_training/evaluate_ppo_from_checkpoint_multi_runs.py
```
