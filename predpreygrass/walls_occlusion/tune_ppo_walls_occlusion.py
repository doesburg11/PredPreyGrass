...
from predpreygrass.walls_occlusion.config.config_env_perimeter_four_gaps_walls import config_env
from predpreygrass.walls_occlusion.utils.episode_return_callback import EpisodeReturn
from predpreygrass.walls_occlusion.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.walls_occlusion.config.config_ppo_gpu_default import config_ppo
    elif num_cpus == 8:
        from predpreygrass.walls_occlusion.config.config_ppo_cpu import config_ppo
    else:
