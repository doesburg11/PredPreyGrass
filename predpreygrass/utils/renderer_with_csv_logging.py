...
class PopulationChart:
    ...
    def save_summary_to_csv(self, summary_data, filepath="renderer_output/evolution_summary.csv"):
        import os
        import csv
        ...
        with open(filepath, mode="w", newline="") as file:
            ...
            writer.writerow(["Episode", "Speed_1_Predator", "Speed_2_Predator", "Speed_1_Prey", "Speed_2_Prey"])
