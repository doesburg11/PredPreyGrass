...
from predpreygrass.parallel_predpreygrass.train.utils.trainer import (
    Trainer
)
from predpreygrass.parallel_predpreygrass.train.utils.config_saver import (
    ConfigSaver
)  
# external libraries
import os
...
if __name__ == "__main__":
    ...
    source_code_dir = up(up(__file__)) # up 4 levels in directory tree
