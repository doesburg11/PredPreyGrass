...
> **In a complex ecosystem, under what minimal conditions do agents evolve from safe solo foraging toward risky cooperation?**

More concretely, in the Predator–Prey–Grass (PPG) environment:

> **When do human predators prefer cooperating to hunt mammoths (risky, coordination-dependent) over solo hunting rabbits (safe, reliable)?**
