...
from predpreygrass.stag_hunt_defection.utils.episode_return_callback import EpisodeReturn
from predpreygrass.stag_hunt_defection.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.stag_hunt_defection.config.config_ppo_gpu_stag_hunt_defection import config_ppo
    elif num_cpus == 8:
        from predpreygrass.stag_hunt_defection.config.config_ppo_cpu_stag_hunt_defection import config_ppo
    else:
