...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.stag_hunt.config.config_ppo_gpu_stag_hunt import config_ppo
    elif num_cpus == 8:
        from predpreygrass.stag_hunt.config.config_ppo_cpu_stag_hunt import config_ppo
    else:
