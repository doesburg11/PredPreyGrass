...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.hyper_parameter_tuning.config.config_ppo_hbp_search import config_ppo
    elif num_cpus == 8:
        from predpreygrass.hyper_parameter_tuning.config.config_ppo_cpu import config_ppo
    else:
