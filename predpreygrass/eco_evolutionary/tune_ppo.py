...
from predpreygrass.eco_evolutionary.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.eco_evolutionary.config.config_ppo_gpu_eco_evolutionary import config_ppo
    elif num_cpus == 8:
        from predpreygrass.eco_evolutionary.config.config_ppo_cpu_eco_evolutionary import config_ppo
    else:
