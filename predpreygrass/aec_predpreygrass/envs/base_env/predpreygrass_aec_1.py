...
from predpreygrass.envs._so_predpreygrass_v0.predpreygrass_base_aec_1 import PredPreyGrass as predpreygrass
...
class raw_env(AECEnv):
    ...
    def observe(self, agent_name):
        ...
        # "black death": return observation of only zeros if agent is not active
        observation = observation if agent_instance.is_active else np.zeros(observation.shape)
        return observation
