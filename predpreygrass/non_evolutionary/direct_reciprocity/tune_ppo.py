...
from predpreygrass.non_evolutionary.direct_reciprocity.utils.episode_return_callback import EpisodeReturn
from predpreygrass.non_evolutionary.direct_reciprocity.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.non_evolutionary.direct_reciprocity.config.config_ppo_gpu_direct_reciprocity import config_ppo
    elif num_cpus == 8:
        from predpreygrass.non_evolutionary.direct_reciprocity.config.config_ppo_cpu_direct_reciprocity import config_ppo
    else:
