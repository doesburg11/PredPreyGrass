...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.non_evolutionary.shared_prey.config.config_ppo_gpu_shared_prey import config_ppo
    elif num_cpus == 8:
        from predpreygrass.non_evolutionary.shared_prey.config.config_ppo_cpu_shared_prey import config_ppo
    else:
