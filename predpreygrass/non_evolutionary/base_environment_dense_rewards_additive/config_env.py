config_env = {
    ...
    "prey_obs_range": 9,
    # Reward: dense per-step net energy delta (see energy settings below) PLUS
    # this flat bonus added to the parent when it reproduces. Unlike
    # base_environment_dense_rewards, this is NOT a pure energy-delta reward --
    # it restores the sparse variant's reproduction incentive on top of the
    # dense signal, to test whether that closes the reproduction-rate/
    # population-balance gap seen against base_environment_sparse_rewards.
