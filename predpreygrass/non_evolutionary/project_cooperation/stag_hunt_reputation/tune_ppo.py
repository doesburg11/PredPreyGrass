...
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_reputation.predpreygrass_rllib_env import PredPreyGrass
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_reputation.config.config_env_stag_hunt_reputation import config_env
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_reputation.utils.episode_return_callback import EpisodeReturn
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_reputation.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_reputation.config.config_ppo_gpu_stag_hunt_reputation import config_ppo
    elif num_cpus == 8:
        from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_reputation.config.config_ppo_cpu_stag_hunt_reputation import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    if trained_example_dir:
        ...
        ray_results_dir = "/home/doesburg/Projects/PredPreyGrass/predpreygrass/stag_hunt_reputation/ray_results/"
