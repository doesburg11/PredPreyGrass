...
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_forward_view.predpreygrass_rllib_env import PredPreyGrass
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_forward_view.config.config_env_stag_hunt_forward_view import config_env
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_forward_view.utils.episode_return_callback import EpisodeReturn
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_forward_view.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_forward_view.config.config_ppo_gpu_stag_hunt_forward_view import config_ppo
    elif num_cpus == 8:
        from predpreygrass.non_evolutionary.project_cooperation.stag_hunt_forward_view.config.config_ppo_cpu_stag_hunt_forward_view import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    version = "STAG_HUNT_FORWARD_ATTEMPT_COST_ONLY"
