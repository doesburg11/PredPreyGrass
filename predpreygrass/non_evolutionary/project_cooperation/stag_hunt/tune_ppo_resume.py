...
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt.config.config_env_stag_hunt_resumed import (
    config_env as resume_env_config,
)
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt.utils.episode_return_callback import EpisodeReturn
from predpreygrass.non_evolutionary.project_cooperation.stag_hunt.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.non_evolutionary.project_cooperation.stag_hunt.config.config_ppo_gpu_stag_hunt_resumed import (
            config_ppo,
        )
    elif num_cpus == 8:
        from predpreygrass.non_evolutionary.project_cooperation.stag_hunt.config.config_ppo_cpu_stag_hunt_resumed import (
            config_ppo,
        )
    else:
...
RESTORE_FROM = Path(
    "/home/doesburg/Projects/PredPreyGrass/predpreygrass/stag_hunt/ray_results/"
...
def main():
    ...
    ray_results_dir = "/home/doesburg/Projects/PredPreyGrass/predpreygrass/stag_hunt/ray_results/"
