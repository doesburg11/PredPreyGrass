...
from predpreygrass.non_evolutionary.project_cooperation.shared_prey.utils.networks_appo import (
...
def get_config_appo():
    ...
    if num_cpus == 32:
        from predpreygrass.non_evolutionary.project_cooperation.shared_prey.config.config_appo_gpu_shared_prey import config_appo
    elif num_cpus == 8:
        from predpreygrass.non_evolutionary.project_cooperation.shared_prey.config.config_appo_cpu_shared_prey import config_appo
    else:
