...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.non_evolutionary.project_cooperation.shared_prey.config.config_ppo_gpu_shared_prey import config_ppo
    elif num_cpus == 8:
        from predpreygrass.non_evolutionary.project_cooperation.shared_prey.config.config_ppo_cpu_shared_prey import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    version = "GRID_30_PRED_OBS_RANGE_9_INITS_15_INIT_PREY_ENERGY_3_5_PUNISH_FAIL_0_2_CAPTURES_EQUAL_SPLIT"
