...
from predpreygrass.stag_hunt_vectorized.config.config_env_stag_hunt_vectorized_resumed import (
    config_env as resume_env_config,
)
from predpreygrass.stag_hunt_vectorized.utils.episode_return_callback import EpisodeReturn
from predpreygrass.stag_hunt_vectorized.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.stag_hunt_vectorized.config.config_ppo_gpu_stag_hunt_vectorized_resumed import (
            config_ppo,
        )
    elif num_cpus == 8:
        from predpreygrass.stag_hunt_vectorized.config.config_ppo_cpu_stag_hunt_vectorized_resumed import (
            config_ppo,
        )
    else:
