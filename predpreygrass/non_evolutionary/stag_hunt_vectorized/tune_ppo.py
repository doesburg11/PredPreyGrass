...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.non_evolutionary.stag_hunt_vectorized.config.config_ppo_gpu_stag_hunt_vectorized import config_ppo
    elif num_cpus == 8:
        from predpreygrass.non_evolutionary.stag_hunt_vectorized.config.config_ppo_cpu_stag_hunt_vectorized import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    version = "STAG_HUNT_PRED_LOSS_0_09"
