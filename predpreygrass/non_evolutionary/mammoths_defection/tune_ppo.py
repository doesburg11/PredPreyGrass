...
from predpreygrass.mammoths_defection.utils.episode_return_callback import EpisodeReturn
from predpreygrass.mammoths_defection.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.mammoths_defection.config.config_ppo_gpu_mammoths import config_ppo
    elif num_cpus == 8:
        from predpreygrass.mammoths_defection.config.config_ppo_cpu_mammoths import config_ppo
    else:
