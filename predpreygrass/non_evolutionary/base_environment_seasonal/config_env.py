config_env = {
    ...
    # Seasonal grass-regrowth cycle: energy_gain_per_step_grass is multiplied by
    # season_high_multiplier for season_length_steps steps, then by
    # season_low_multiplier for the next season_length_steps steps, repeating.
    "season_length_steps": 40,
