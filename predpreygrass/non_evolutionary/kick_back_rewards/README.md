...
- **kick_back_rewards**: `predpreygrass/kick_back_rewards/predpreygrass_rllib_env_works_1.py`
...
- **kick_back_rewards**: `predpreygrass/kick_back_rewards/predpreygrass_rllib_env_works_3.py`

-kinship rewards for parents when offspring survive time steps

- **kick_back_rewards**: `predpreygrass/kick_back_rewards/predpreygrass_rllib_env_works_4.py`
-kinship rewards for parents when offspring survive time steps
-integrated kinship rewards into config_env_rllib_termination.py
- **kick_back_rewards**: `predpreygrass/kick_back_rewards/predpreygrass_rllib_env_works_5.py`
...
- **kick_back_rewards**: `predpreygrass/kick_back_rewards/predpreygrass_rllib_env_works_6.py`
- simplify config options
- remove unused rewards
- **kick_back_rewards**: `predpreygrass/kick_back_rewards/predpreygrass_rllib_env_works_7.py`
...
- **kick_back_rewards**: `predpreygrass/kick_back_rewards/predpreygrass_rllib_env_works_8.py`
 - Dead-prey carcasses:
