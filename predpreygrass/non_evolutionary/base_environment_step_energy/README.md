...
**Open**: why seed 45 fell behind early, and whether a slightly easier predator cost, an entropy bonus, longer training or more seeds change the failure rate; how long the stability of the other seeds holds beyond 500 iterations; and what causes the extra predator clustering (`RESULTS.md` §16-18).
