...
and runs them in the PredPreyGrass environment (base_environment_step_energy) for interactive debugging.
...
"""
# --- Project imports (base_environment_step_energy env + PyGame renderer) ---
from predpreygrass.non_evolutionary.base_environment_step_energy.predpreygrass_rllib_env import PredPreyGrass
from predpreygrass.non_evolutionary.base_environment_step_energy.utils.pygame_grid_renderer_rllib import (
    PyGameRenderer,
    ViewerControlHelper,
    LoopControlHelper,
)
...
if __name__ == "__main__":
    ...
    checkpoint_path = os.path.join(
        ...
        "simulation_results",
        "ray_results",
        "PPO_STEP_ENERGY_ADDITIVE_PREDEASE_CONFIRM500_SEED42",
        "PPO_PredPreyGrass_eed47_00000_0_2026-09-17_07-30-45",
        "checkpoint_000049",
    )
