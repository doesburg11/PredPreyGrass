...
class PredPreyGrass(MultiAgentEnv):
    def __init__(self, config=None):
        ...
        # The one action that leaves position unchanged -- exempt from the
        # movement energy cost. Derived rather than hardcoded so it stays
        # correct if action_to_move_tuple is ever reordered.
