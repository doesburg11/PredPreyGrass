...
Uses the dense per-step energy-delta reward (see predpreygrass_rllib_env.py);
compare training dynamics against
...
if __name__ == "__main__":
    ...
    experiment_name = f"PPO_BASE_ENVIRONMENT_DENSE_REWARDS_{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}"
