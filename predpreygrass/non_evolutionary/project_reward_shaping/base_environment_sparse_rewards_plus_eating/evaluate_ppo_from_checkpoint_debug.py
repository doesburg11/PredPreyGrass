...
from predpreygrass.non_evolutionary.project_reward_shaping.base_environment_sparse_rewards_plus_eating.predpreygrass_rllib_env import PredPreyGrass
from predpreygrass.non_evolutionary.project_reward_shaping.base_environment_sparse_rewards_plus_eating.utils.pygame_grid_renderer_rllib import (
    PyGameRenderer,
    ViewerControlHelper,
    LoopControlHelper,
)
...
if __name__ == "__main__":
    ...
    checkpoint_path = os.path.join(
        os.path.expanduser("~"),
        "ray_results",
        "PPO_BASE_ENVIRONMENT_SPARSE_REWARDS_PLUS_EATING_2026-07-31_17-26-12",
        "PPO_PredPreyGrass_29f27_00000_0_2026-07-31_17-26-12",
        "checkpoint_000099",
    )
