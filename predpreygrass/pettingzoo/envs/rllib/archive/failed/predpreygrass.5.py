...
if __name__ == "__main__":
    ...
    for step in range(num_steps):
        ...
        # Create empty grids for predators and prey
        ...
        # Populate the grids with agent positions
        for agent, position in env.agent_positions.items():
            x, y = position
            if "predator" in agent:
                predator_grid[x, y] = "X"  # Mark predator positions
            elif "prey" in agent:
                prey_grid[x, y] = "X"  # Mark prey positions
