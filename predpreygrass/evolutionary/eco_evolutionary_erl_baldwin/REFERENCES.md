...
## Core hybrid ERL algorithms (EA population + gradient-based RL)
...
## Pure evolutionary / neuroevolution approaches to RL
...
## Exploration & diversity-driven methods
...
## Population-based training (hyperparameters/policies co-evolved)

- [Population Based Training of Neural Networks (PBT)](https://arxiv.org/abs/1711.09846) (Jaderberg et al. — DeepMind, 2017)

## Baldwin effect (evolution ↔ learning interaction)

Directly relevant to this experiment's ERL Baldwin design.
...
## GPU-scale / modern infrastructure
