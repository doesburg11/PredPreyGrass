...
class Genome:
    ...
    metabolic_rate: scales energy gain super-linearly (exponent alpha=3.0) and energy
        cost linearly, creating an overwhelming monotonic fitness advantage for high
        metabolic_rate. Positive-control variant of the parent module's sub-linear
        (interior-optimum) design -- see this module's RESULTS.md.
    """
