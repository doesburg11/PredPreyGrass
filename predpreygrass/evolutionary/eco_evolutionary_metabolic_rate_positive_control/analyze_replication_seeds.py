...
Usage:
    python predpreygrass/eco_evolutionary_metabolic_rate_positive_control/analyze_replication_seeds.py
"""
...
CONTROL_PATTERN = re.compile(r"^PPO_ECO_EVOLUTION_METABOLIC_RATE_POSITIVE_CONTROL_NEUTRAL_CONTROL_SEED(\d+)_")
...
def find_seed_runs(pattern: re.Pattern) -> dict[int, Path]:
    ...
    for exp_dir in RAY_RESULTS_DIR.glob("PPO_ECO_EVOLUTION_METABOLIC_RATE_POSITIVE_CONTROL*"):
