"""
Neutral-drift control for the eco_evolutionary_metabolic_rate_positive_control environment.
...
from predpreygrass.evolutionary.eco_evolutionary_metabolic_rate_positive_control.config.config_env_eco_evolutionary_neutral_control import config_env
...
if __name__ == "__main__":
    ...
    version = f"ECO_EVOLUTION_METABOLIC_RATE_POSITIVE_CONTROL_NEUTRAL_CONTROL{seed_tag}"
