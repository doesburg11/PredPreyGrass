...
from predpreygrass.evolutionary.eco_evolutionary_investment.utils.genome import Genome
...
def test_mutation_never_violates_trait_bounds():
    from predpreygrass.evolutionary.eco_evolutionary_investment.utils.genome import mutate_genome
