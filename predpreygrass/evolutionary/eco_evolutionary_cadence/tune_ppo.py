...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.evolutionary.eco_evolutionary_cadence.config.config_ppo_gpu_eco_evolutionary import config_ppo
    elif num_cpus == 8:
        from predpreygrass.evolutionary.eco_evolutionary_cadence.config.config_ppo_cpu_eco_evolutionary import config_ppo
    else:
        from predpreygrass.evolutionary.eco_evolutionary_cadence.config.config_ppo_cpu_eco_evolutionary import config_ppo
    return config_ppo
