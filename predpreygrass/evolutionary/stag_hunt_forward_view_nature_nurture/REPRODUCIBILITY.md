...
```
REPRODUCE_CODE/
  predpreygrass/<module_name>/   # snapshot of this module only
...
### What is included
- **Code snapshot** of only `predpreygrass/<module_name>` (no other modules).
...
```bash
python /path/to/EXPERIMENT/REPRODUCE_CODE/predpreygrass/stag_hunt_forward_view_nature_nurture/tune_ppo.py
```
...
```bash
python /path/to/EXPERIMENT/REPRODUCE_CODE/predpreygrass/stag_hunt_forward_view_nature_nurture/evaluate_ppo_from_checkpoint_debug.py
```

or

```bash
python /path/to/EXPERIMENT/REPRODUCE_CODE/predpreygrass/stag_hunt_forward_view_nature_nurture/evaluate_ppo_from_checkpoint_multi_runs.py
```
