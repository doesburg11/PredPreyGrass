...
class PredPrey:
    ...
    def reset(self):
        ...
        for predator_instance in self.predator_instance_list:
            if predator_instance.agent_id_nr > 4: # number of initial active predators
               predator_instance.energy = 0.0
        for prey_instance in self.prey_instance_list:
            if prey_instance.agent_id_nr > 20+10: # number of initial active predators
