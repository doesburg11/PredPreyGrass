...
from pettingzoo.predpreygrass.predprey_1.utils import agent_utils, two_d_maps
from pettingzoo.predpreygrass.predprey_1.utils.agent_layer import AgentLayer
from pettingzoo.predpreygrass.predprey_1.utils.controllers import (
    PredPreyPolicy,
    RandomPolicy,
    SingleActionPolicy,
)
...
class PredPrey:
    def __init__(
        ...
        xb, yb:  xb and yb are buffers for each dim representing 
        the ratio of the map to leave open on each side
        ...
        self.xb = xb
        self.yb = yb
        self.map_matrix = two_d_maps.rectangle_map(self.x_size, self.y_size, xb=self.xb, yb=self.yb)
