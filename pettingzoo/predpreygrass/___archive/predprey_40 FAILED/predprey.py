...
class PredPrey:
    def __init__(
        ...
        # lists of agents
        # initialization
        self.possible_predator_instance_list = [] # list of all active and inactive predator instances
        self.possible_prey_instance_list = [] # list of all active and inactive prey instances
        self.possible_grass_instance_list = [] # list of all active and inactive grass instances
        self.possible_agent_instance_list = [] # list of all active and inactive agents instances
        self.possible_predator_name_list = []
        self.possible_prey_name_list = []
        self.possible_grass_name_list = []

        self.active_predator_instance_list = [] # list of all active predator
        self.active_prey_instance_list = [] # list of all active prey
        self.active_grass_instance_list = [] # list of all active grass
        self.active_agent_instance_list = [] # list of all active agents
        self.active_predator_name_list = []
        self.active_prey_name_list = []
        self.active_grass_name_list = []
        ...
        # 'n_possible_agents' is the PredPrey equivalent of PettingZoo 'num_agents' in raw_env
        ...
        self.active_predator_name_list = self.possible_predator_name_list
        self.active_prey_name_list = self.possible_prey_name_list
        self.active_grass_name_list = self.possible_grass_name_list
        self.active_agent_name_list = self.possible_agent_name_list
    ...
    def create_agent_instance_list(
        ...
        for _ in range(n_possible_agents): 
    ...
    def reset(self):
        ...
        print("self.agent_name_to_instance_dict = ", self.agent_name_to_instance_dict)
        print()
        ...
        if is_last: # removes agents and reap rewards at the end of the cycle
            for predator_name in self.possible_predator_name_list:
                if self.predator_alive_dict[predator_name]:
                    ...
                    if self.predator_to_be_removed_by_starvation_dict[predator_name]:
                        self.possible_predator_instance_list.remove(predator_instance)
                        self.n_possible_predator -= 1
                        self.model_state[
                            agent_type_nr, 
            ...
            for prey_name in self.possible_prey_name_list:
                if self.prey_alive_dict[prey_name]:
                    ...
                    if self.prey_to_be_removed_by_predator_dict[prey_name] or self.prey_to_be_removed_by_starvation_dict[prey_name]:
                        ...
                        self.possible_prey_instance_list.remove(prey_instance)
                        self.n_possible_prey -= 1
                        self.model_state[
                            agent_type_nr, 
            ...
            for grass_name in self.possible_grass_name_list:
                ...
                if self.grass_to_be_removed_by_prey_dict[grass_name]:
                    ...
                    #print()
                    self.possible_grass_instance_list.remove(grass_instance)
                    self.n_possible_grass -= 1
                    self.model_state[
                        agent_type_nr, 
    ...
    def is_no_grass(self):
        if self.n_possible_grass == 0:
            return True
        return False

    @property
    def is_no_prey(self):
        if self.n_possible_prey == 0:
            return True
        return False

    @property
    def is_no_predator(self):
        if self.n_possible_predator == 0:
            return True
        return False
