...
class PredPrey:
    ...
    def remove_agent_instance_list(
            self, 
            n_agents,
            agent_type_nr,
            observation_range, 
    ...
    def reset(self):
        ...
        self.prey1_instance_list = self.remove_agent_instance_list(
        ...
        self.prey2_instance_list = self.remove_agent_instance_list(
        ...
        self.grass_instance_list = self.remove_agent_instance_list(
    ...
    def step(self, action, agent_instance, is_last):
        ...
        if is_last:
            ...
            for prey_name in self.prey_name_list:
                self.pred_prey_rewards_dict[prey_name] += self.catch_reward * prey_who_remove_grass_dict[prey_name] 
                self.pred_prey_rewards_dict[prey_name] += self.urgency_reward
    ...
    def remove_grass(self):
        ...
        for grass_name in self.grass_name_list:
            if self.grasses_gone_dict[grass_name]:
                continue
            grass_instance = self.agent_name_to_instance_mapping[grass_name]
