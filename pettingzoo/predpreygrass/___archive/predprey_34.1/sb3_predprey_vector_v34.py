...
if __name__ == "__main__":
    ...
    training_steps_string = "20_000_000"
    training_steps = int(training_steps_string)
    loaded_policy = "./trained_models/predprey/predprey_2024-01-05_00:27/predprey_steps_10_000_000.zip"
    env_kwargs = dict(
        max_cycles=10000, 
        x_grid_size=16,
        y_grid_size=16, 
    ...
    if train_model:
        ...
        file.write("version: predprey_v34.1 \n")
