from pettingzoo.predpreygrass.predprey_5 import predprey_v5
...
"""
TODO moore_neighborhood_evaders=False does not work with moore_neighborhood_pursuers=True
because it uses n_actions from pursuers (9), so action can be 8 whereas the motion_range 
has only length 5 for evaders in that case; line 525
"""
...
env = predprey_v5.env(**env_kwargs)  # this calls raw_env
