...
if __name__ == "__main__":
    ...
    destination_directory_source_code = os.path.join('/home/doesburg/Dropbox/02_marl_results/predpreygras_results/energy_loss_per_step_predator/-0.09', start_time)
