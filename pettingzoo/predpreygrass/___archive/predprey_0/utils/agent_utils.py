...
from pettingzoo.predpreygrass.predprey_0.utils.discrete_agent import DiscreteAgent
...
def create_agents(
    ...
    for i in range(nagents):
        ...
        agent = DiscreteAgent(
            xs, ys, map_matrix, obs_range=obs_range, flatten=flatten, moore_neighborhood=moore_neighborhood
        )
