...
from config.config_pettingzoo_benchmark_2 import env_kwargs, training_steps_string, local_output_directory
...
if __name__ == "__main__":
    ...
    # Copy all files and directories in the current directory to the local
    ...
    saved_directory_and_parameter_file_name = os.path.join(output_directory, "parameters.txt")
