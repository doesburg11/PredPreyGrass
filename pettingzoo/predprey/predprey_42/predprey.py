...
class PredPrey:
    ...
    def reset(self):
        ...
        # add agents to position dict for more efficient searching/observation in step function
        ...
        #print("self.possible_predator_name_list", self.possible_predator_name_list)
        #print("self.possible_prey_name_list", self.possible_prey_name_list)
        # end removal agents

        # intialize the active lists
        ...
        self.active_predator_instance_list = self.possible_predator_instance_list
        self.active_prey_instance_list = self.possible_prey_instance_list
        self.active_grass_instance_list = self.possible_grass_instance_list
