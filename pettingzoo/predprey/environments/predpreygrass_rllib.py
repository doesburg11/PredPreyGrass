...
class raw_env(EzPickle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.pred_prey_env = PredPreyGrassEnv(*args, **kwargs) #  this calls the code from PredPrey
    ...
    def step(self, actions):
        ...
        for agent_name in self.agents:
            self.observations[agent_name] = self.pred_prey_env.observe(agent_name)
            self.rewards[agent_name] = self.pred_prey_env.agent_reward_dict[agent_name]
            self.terminations[agent_name] = not self.pred_prey_env.agent_name_to_instance_dict[agent_name].is_alive
