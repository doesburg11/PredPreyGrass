...
class PredPrey:
    def __init__(
        ...
        # creation
        self.agent_names_list = [self.agent_type_names[self.prey_type_nr] + "_" + 
                                 str(a) for a in range(self.num_agents)]
        self.possible_agents = self.agent_names_list[:]
    ...
    def _seed(self, seed=None):
        ...
        try:
            ...
            for policy in policies:
                try:
                    policy.set_rng(self.np_random) # type: ignore
...
class raw_env(AECEnv, EzPickle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.agents = self.pred_prey_env.agent_names_list 
