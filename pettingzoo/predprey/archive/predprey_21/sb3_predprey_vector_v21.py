...
def eval(env_fn, num_games: int = 100, render_mode: str | None = None, **env_kwargs):
    ...
    for i in range(num_games):
        ...
        agent_name_list = raw_env.pred_prey_env.agent_name_aec_list
        """
        print("predator_name_list ",predator_name_list)
        print("prey_name_list ",prey_name_list)
        print("agent_name_list ",agent_name_list)
        print()
        """
        cumulative_rewards = {agent: 0 for agent in agent_name_list}
        cumulative_rewards1 = {agent: 0 for agent in predator_name_list}
        cumulative_rewards2 = {agent: 0 for agent in prey_name_list}
        """
        print("cumulative_rewards ",cumulative_rewards)
        print("cumulative_rewards1 ",cumulative_rewards1)
        print("cumulative_rewards2 ",cumulative_rewards2)
        """
...
if __name__ == "__main__":
    ...
    loaded_policy = "./trained_models/predprey/predprey_2023-12-12 00:41/predprey_steps_1_000_000"
