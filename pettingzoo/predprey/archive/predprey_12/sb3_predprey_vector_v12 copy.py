...
def eval(env_fn, num_games: int = 100, render_mode: str | None = None, **env_kwargs):
    ...
    agents1 = ["prey_0","prey_1","prey_2","prey_3"]
    agents2 = ["prey_4","prey_5","prey_6","prey_7"]
    ...
    for i in range(num_games):
        ...
        cumulative_rewards = {agent: 0 for agent in env.possible_agents}
        cumulative_rewards1 = {agent: 0 for agent in agents1}
        cumulative_rewards2 = {agent: 0 for agent in agents2}
        n_cycles = 0
