...
class PredPrey:
    def __init__(
        ...
        # agent types
        self.agent_type_name_list = ["predator", "prey", "grass"]  # different types of agents 
    ...
    def reset(self):
        ...
        self.n_agent_instance_list = [self.n_active_predator, self.n_active_prey, self.n_active_grass]
        self.obs_range_list = [self.obs_range_predator, self.obs_range_prey, 0]
        self.initial_energy_list = [self.initial_energy_predator, self.initial_energy_prey, 0]
        self.energy_loss_per_step_list = [self.energy_loss_per_step_predator, self.energy_loss_per_step_prey, 0]
        ...
        # create agents
        for agent_type_nr in range(len(self.agent_type_name_list)):
