...
if __name__ == "__main__":
    ...
    destination_directory_source_code = os.path.join('/home/doesburg/Dropbox/02_marl_results/predpreygras_results/energy_loss_per_step_predator/-0.12', start_time)
