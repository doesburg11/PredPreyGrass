...
class PredPrey:
    ...
    def reset(self):
        ...
        #print("self.prey1_name_list ", self.prey1_name_list)
        #print("self.prey2_name_list ", self.prey2_name_list)
...
class raw_env(AECEnv, EzPickle):
    ...
    def step(self, action):
        ...
        for k in self.agents:
            ...
            self.rewards[k] = self.pred_prey_env.latest_reward_state[self.agent_name_to_index_mapping[k]]
        self.steps += 1
