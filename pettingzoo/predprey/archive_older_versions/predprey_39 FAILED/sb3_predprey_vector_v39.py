...
if __name__ == "__main__":
    ...
    loaded_policy = "./trained_models/predprey/predprey_2024-01-07_21:48/predprey_steps_10_000_000.zip"
    env_kwargs = dict(
        max_cycles=10000, 
        x_grid_size=16,
        y_grid_size=16, 
    ...
    if train_model:
        ...
        file.write("version: predprey_v39 \n")
        ...
        #cProfile.run('train(env_fn, steps=training_steps, seed=0, **env_kwargs)', 'output.dat')
        p = pstats.Stats('output.dat')
        p.sort_stats('cumulative').print_stats(10)  # Prints the top 10 functions sorted by cumulative time
