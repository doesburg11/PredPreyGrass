"""
[-v40]
-remove create_agent_list create_agent
...
class PredPrey:
    def __init__(
        ...
        # lists of agents
        # initialization
        self.n_predator = self.n_possible_predator # self.n_predator is active number of predators <= self.n_possible_predator
        self.n_prey = self.n_possible_prey  # self.n_prey is active number of prey <= self.n_possible_prey
        self.n_grass = self.n_possible_grass # self.n_grass is active number of grass <= self.n_possible_grass
        self.possible_predator_instance_list = [] # list of all active predator
        self.predator_instance_list = [] # list of all active predator
        self.prey_instance_list = [] # list of all active prey
        self.grass_instance_list = [] # list of all active grass
        self.agent_instance_list = [] # list of all active agents
        self.predator_name_list = [] # list of all possible predator names
        self.prey_name_list = [] # list of all possible prey names
        self.grass_name_list = [] # list of all possible grass names
        ...
        # needs likely to be changed to possible
    ...
    def reset(self):
        ...
        # initialization
        self.n_predator = self.n_possible_predator
        self.n_prey = self.n_possible_prey  
        self.n_grass = self.n_possible_grass
        ...
        self.prey_who_remove_grass_dict = dict(zip(self.possible_prey_instance_list, [False for _ in self.possible_prey_instance_list]))
        self.grass_to_be_removed_by_prey_dict = dict(zip(self.possible_grass_instance_list, [False for _ in self.possible_grass_instance_list]))
        ...
        # learning agents,so not grass agents    
