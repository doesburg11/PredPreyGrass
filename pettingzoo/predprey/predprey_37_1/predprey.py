...
class AgentLayer:
    def __init__(self, x_grid_size, y_grid_size, agent_type_instance_list):

        self.agent_type_instance_list = agent_type_instance_list
        self.x_grid_size = x_grid_size
        self.y_grid_size = y_grid_size
    ...
    def get_global_state_ally_agents(self):
        ...
        for ally_agent_instance in self.agent_type_instance_list:
