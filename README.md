...
- <img src="https://github.com/doesburg11/PredPreyGrass/blob/main/assets/images/icons/PettingZoo.svg" alt="PettingZoo" width="20"> **[PettingZoo](https://pettingzoo.farama.org/) environment** and <img src="https://github.com/doesburg11/PredPreyGrass/blob/main/assets/images/icons/sb3.webp" alt="Stable-Baselines3" width="20"> **Stable-Baselines3 (PPO) algorithm**
- <img src="https://github.com/doesburg11/PredPreyGrass/blob/main/assets/images/icons/rllib.png" alt="RLlib" width="20"> **RLlib (new API stack) environment** and RLlib native PPO solution
