config_env = {
    ...
    # Solo capture remains possible for predators; cooperation happens via voluntary sharing after capture.
    "team_capture_margin": 0.0,  # optional safety margin; set >0 to demand extra energy
    "team_capture_equal_split": False,
    "direct_reciprocity_enabled": True,
    "share_fraction": 0.25,
    "trust_enabled": True,
    "include_trust_channel": True,
    "include_trust_summary": False,
    "trust_neutral": 0.5,
    "trust_positive_delta": 0.15,
    "trust_negative_delta": 0.10,
    "trust_decay": 0.01,
    "trust_visibility_range": 9,
