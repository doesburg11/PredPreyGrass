...
from predpreygrass.rllib.direct_reciprocity.utils.episode_return_callback import EpisodeReturn
from predpreygrass.rllib.direct_reciprocity.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.direct_reciprocity.config.config_ppo_gpu_direct_reciprocity import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.direct_reciprocity.config.config_ppo_cpu_direct_reciprocity import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    ray_results_dir = "/home/doesburg/Projects/PredPreyGrass/src/predpreygrass/rllib/direct_reciprocity/ray_results/"
