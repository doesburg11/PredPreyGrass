...
if __name__ == "__main__":
    ...
    cfg.setdefault("max_eating_predator", 1.0)
    cfg.setdefault("max_eating_prey", 1.0)
    # Keep carcasses persistent for viewing (no decay, unlimited lifetime)
    cfg.setdefault("carcass_decay_per_step", 0.0)
    cfg.setdefault("carcass_max_lifetime", None)
    env = env_creator(cfg)
