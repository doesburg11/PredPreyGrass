...
"""
from predpreygrass.rllib.kick_back_rewards.predpreygrass_rllib_env import PredPreyGrass
from predpreygrass.rllib.kick_back_rewards.config.config_env_kick_back_rewards import config_env
from predpreygrass.rllib.kick_back_rewards.utils.episode_return_callback import EpisodeReturn
from predpreygrass.rllib.kick_back_rewards.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.kick_back_rewards.config.config_ppo_gpu_kick_back_rewards import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.kick_back_rewards.config.config_ppo_cpu_kick_back_rewards import config_ppo
    else:
