...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.walls_occlusion_efficiency.config.config_ppo_gpu_default import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.walls_occlusion_efficiency.config.config_ppo_cpu import config_ppo
    else:
