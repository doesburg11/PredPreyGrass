...
"""
from predpreygrass.rllib.v2_7.predpreygrass_rllib_env import PredPreyGrass  # Import the custom environment
from predpreygrass.rllib.v2_7.config.config_env_eval import config_env
from predpreygrass.rllib.v2_7.utils.matplot_renderer import CombinedEvolutionVisualizer, PreyDeathCauseVisualizer
from predpreygrass.rllib.v2_7.utils.pygame_grid_renderer_rllib import PyGameRenderer, ViewerControlHelper, LoopControlHelper
...
def setup_environment_and_visualizer(now):
    ...
    visualizer = PyGameRenderer(grid_size, cell_size=32, max_steps=config_env.get("max_steps", 1000))
