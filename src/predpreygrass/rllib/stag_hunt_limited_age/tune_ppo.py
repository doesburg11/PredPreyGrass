...
from predpreygrass.rllib.stag_hunt_limited_age.predpreygrass_rllib_env import PredPreyGrass
from predpreygrass.rllib.stag_hunt_limited_age.config.config_env_stag_hunt_limited_age import config_env
from predpreygrass.rllib.stag_hunt_limited_age.utils.episode_return_callback import EpisodeReturn
from predpreygrass.rllib.stag_hunt_limited_age.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.stag_hunt_limited_age.config.config_ppo_gpu_stag_hunt_limited_age import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.stag_hunt_limited_age.config.config_ppo_cpu_stag_hunt_limited_age import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    version = "STAG_HUNT_LIMITED_AGE_JOIN_COST_0_02_SCAVENGER_0_4"
