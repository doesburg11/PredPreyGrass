config_env = {
    ...
    # Energy settings
    "energy_loss_per_step_predator": 0.07,
    ...
    "n_initial_active_speed_1_predator": 10,
    "n_initial_active_speed_1_prey": 14,
    ...
    "mutation_rate_prey": 0.00,      # and vice versa
        
    # Grass settings
    "initial_num_grass": 35,
