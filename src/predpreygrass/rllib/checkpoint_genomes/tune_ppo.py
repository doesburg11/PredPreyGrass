...
from predpreygrass.rllib.checkpoint_genomes.predpreygrass_rllib_env import PredPreyGrass
from predpreygrass.rllib.checkpoint_genomes.config.config_env_checkpoint_genomes import config_env
from predpreygrass.rllib.checkpoint_genomes.utils.episode_return_callback import EpisodeReturn
from predpreygrass.rllib.checkpoint_genomes.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.checkpoint_genomes.config.config_ppo_gpu_checkpoint_genomes import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.checkpoint_genomes.config.config_ppo_cpu_checkpoint_genomes import config_ppo
    else:
