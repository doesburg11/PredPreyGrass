...
if __name__ == "__main__":
    ...
    # Choose agent-side DFT model (set to False to use plain CNN)
    USE_AGENT_DFT = True
    if USE_AGENT_DFT:
        # Optional: adjust DFT parameters per your taste
        dft_params = {
            "dt": 1.0,
            "tau": 10.0,
            "gamma": 0.55,
        ...
        multi_module_spec = build_multi_module_spec_agent_dft(
            obs_by_policy, act_by_policy, prey_channel_index=2, dft_params=dft_params
        )
    else:
