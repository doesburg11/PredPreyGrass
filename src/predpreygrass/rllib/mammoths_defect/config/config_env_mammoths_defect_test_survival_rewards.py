config_env = {
    ...
    "reward_per_step_predator": {
        "type_1_predator": 0.0,  # 1.0 / max_steps
        "type_2_predator": 0.0,
    },
    "reward_per_step_prey": {
        "type_1_prey": 0.0,
        "type_2_prey": 0.0,
    },
    "extinction_penalty": -1.0,
    # Energy settings
    ...
    # Optionally append a joiner-intent channel (changes observation shape).
    "include_joiner_channel": True,
