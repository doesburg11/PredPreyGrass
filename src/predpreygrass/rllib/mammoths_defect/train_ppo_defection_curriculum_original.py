...
- Phase 1: defection_enabled=True but force_all_join=True (join flag ignored, always join).
...
if __name__ == "__main__":
    ...
    # Phase 1: keep MultiDiscrete, but force join_hunt=1
    phase1_env = {
        **base_env_cfg,
    ...
    # Phase 1 setup
    phase1_name = f"{base_version}_PHASE1_DEF_OFF_{timestamp}"
