...
from predpreygrass.rllib.v5_1_reward_scaling.config.config_env import config_env
        ...
        for agent, action in action_dict.items():
            if agent in self.agent_positions:
                ...
                if self.verbose_movement:
                    ...
                    print(
                        f"[MOVE] {agent} new position: {self.agent_positions[agent]} with energy: {self.agent_energies[agent]:.2f}"
                    )
                    print(
                        "----------------------------------------------------------------------------------------------------------"
                    )
