...
"""
from predpreygrass.rllib.walls_occlusion_vectorization_1.predpreygrass_rllib_env import PredPreyGrass
...
from predpreygrass.rllib.walls_occlusion_vectorization_1.utils.episode_return_callback import EpisodeReturn
from predpreygrass.rllib.walls_occlusion_vectorization_1.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.walls_occlusion_vectorization_1.config.config_ppo_gpu_walls_oclussion_vectorization import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.walls_occlusion_vectorization_1.config.config_ppo_cpu_walls_oclussion_vectorization import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    experiment_name = f"PPO_WALLS_OCCLUSION_VECTORIZATION_1_{timestamp}"
