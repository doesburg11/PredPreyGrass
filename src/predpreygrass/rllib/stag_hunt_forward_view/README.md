...
All imports inside this module point to `predpreygrass.rllib.stag_hunt_forward_view.*`
...
- Train: `python src/predpreygrass/rllib/stag_hunt_forward_view/tune_ppo.py`
- Random rollouts: `python src/predpreygrass/rllib/stag_hunt_forward_view/random_policy.py`
...
```bash
# Train
PYTHONPATH=src python src/predpreygrass/rllib/stag_hunt_forward_view/tune_ppo.py

# Random rollout viewer
PYTHONPATH=src python src/predpreygrass/rllib/stag_hunt_forward_view/random_policy.py

# Evaluate a checkpoint (debug viewer)
PYTHONPATH=src python src/predpreygrass/rllib/stag_hunt_forward_view/evaluate_ppo_from_checkpoint_debug.py

# Evaluate multiple runs (batch)
PYTHONPATH=src python src/predpreygrass/rllib/stag_hunt_forward_view/evaluate_ppo_from_checkpoint_multi_runs.py
```
