...
from predpreygrass.rllib.stag_hunt_forward_view.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.stag_hunt_forward_view.config.config_ppo_gpu_stag_hunt_forward_view import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.stag_hunt_forward_view.config.config_ppo_cpu_stag_hunt_forward_view import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    version = "STAG_HUNT_FORWARD_VIEW_JOIN_COST_0_03_SCAVENGER_0_2"
