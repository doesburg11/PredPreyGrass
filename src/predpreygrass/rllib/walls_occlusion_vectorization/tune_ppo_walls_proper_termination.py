...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.walls_occlusion_vectorization.config.config_ppo_gpu_walls_oclussion_vectorization import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.walls_occlusion_vectorization.config.config_ppo_cpu_walls_oclussion_vectorization import config_ppo
    else:
