...
- Predators can eat prey and prey can eat grass to replenish their energy.
...
- Grass gradually regenerates at the same spot after being eaten by Prey. Grass, as a non-learning agent, is regarded by the model as part of the environment, not as an actor.
