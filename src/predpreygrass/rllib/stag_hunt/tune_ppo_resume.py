...
from predpreygrass.rllib.stag_hunt.config.config_env_stag_hunt_resumed import (
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.stag_hunt.config.config_ppo_gpu_stag_hunt_resumed import (
            config_ppo,
        )
    elif num_cpus == 8:
        from predpreygrass.rllib.stag_hunt.config.config_ppo_cpu_stag_hunt_resumed import (
            config_ppo,
        )
    else:
...
RESTORE_FROM = Path(
    "/home/doesburg/Projects/PredPreyGrass/src/predpreygrass/rllib/stag_hunt/ray_results/"
