...
class PredPreyGrass(MultiAgentEnv):
    ...
    def _register_new_agent(self, agent_id: str, parent_unique_id: str = None):
        """
        Initialize all statistics and internal bookkeeping for a newly created agent.
        Called both during reset and during reproduction.

        Args:
            agent_id (str): The logical agent ID, e.g. 'speed_2_prey_3'
            parent_unique_id (str, optional): The unique ID of the parent agent.
        """
        # Assign unique shadow ID
        ...
        self.unique_agent_stats[unique_id] = {
            ...
            "energy_gained": 0.0,
            "energy_spent": 0.0,
            "avg_energy_sum": 0.0,  # For computing avg later
            "avg_energy_steps": 0,
            "cumulative_reward": 0.0,
            "policy_group": "_".join(agent_id.split("_")[:3]),
            "mutated": False,  # You can update this later
            "death_step": None,
            "death_cause": None,
        }
