config_env = {
    ...
    "n_initial_active_type_1_prey": 20,  # 10
    "n_initial_active_type_2_prey": 0,
    # Grass settings
    "initial_num_grass": 120,  # 100
