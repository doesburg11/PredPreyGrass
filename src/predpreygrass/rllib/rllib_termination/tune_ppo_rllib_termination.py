...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.rllib_termination.config.config_ppo_gpu_rllib_termination import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.rllib_termination.config.config_ppo_cpu_rllib_termination import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    version = "0_2"
    experiment_name = f"PPO_KIN_KICK_BACK_REWARD_{version}_{timestamp}"
