...
print("✅ Loaded: episode_return_callback.EpisodeReturn (correct version)")


class EpisodeReturn(RLlibCallback):
    algo_ref = None  # Reference to the algorithm instance (injected manually after build)
    ...
    def __init__(self):
        ...
        print("✅ Using correct EpisodeReturn class")
    ...
    def on_train_result(self, *, result, **kwargs):
        ...
        # Modify env reward weights at iteration 1
        if EpisodeReturn.algo_ref is not None and iter_num == 1:
            env = EpisodeReturn.algo_ref.workers().local_worker().env.envs[0]
            print(f"✅ env.reward_weights = {env.reward_weights}")
