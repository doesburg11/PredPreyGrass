...
def load_predpreygrass_modules() -> None:
    ...
    from predpreygrass.rllib.stag_hunt_forward_view_nature_nurture.predpreygrass_rllib_env import PredPreyGrass as _PredPreyGrass
    from predpreygrass.rllib.stag_hunt_forward_view_nature_nurture.config.config_env_stag_hunt_forward_view import config_env as _config_env
    from predpreygrass.rllib.stag_hunt_forward_view_nature_nurture.utils.matplot_renderer import (
...
def setup_modules():
    if TRAINED_EXAMPLE_DIR:
        ...
        # /home/doesburg/Projects/PredPreyGrass/src/predpreygrass/rllib/stag_hunt_forward_view_nature_nurture/ray_results/join_cost_0.02/STAG_HUNT_FORWARD_VIEW_JOIN_COST_0_02_SCAVENGER_0_5_2026-02-04_23-51-56/PPO_PredPreyGrass_1b536_00000_0_2026-02-04_23-51-56/checkpoint_000099
        ray_results_dir = "/home/doesburg/Projects/PredPreyGrass/src/predpreygrass/rllib/stag_hunt_forward_view_nature_nurture/ray_results/join_cost_0.02"
...
if __name__ == "__main__":
    ...
    if filtered_runs:
        ...
        if SAVE_EVAL_RESULTS:
            ...
            try:
                from predpreygrass.rllib.stag_hunt_forward_view_nature_nurture.utils.summarize_capture_failures import (
