...
Example:
    PYTHONPATH=src .conda/bin/python \
        src/predpreygrass/rllib/malthusian_rl/scripts/run_exact_reproduction_seeds.py \
        --seeds 0 1 2
"""
...
def run_seed(
    *,
    ...
    trainer = repo_root / "src/predpreygrass/rllib/malthusian_rl/tune_appo_malthusian_exact.py"
    env = os.environ.copy()
