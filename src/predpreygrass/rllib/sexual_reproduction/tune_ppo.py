...
from predpreygrass.rllib.sexual_reproduction.predpreygrass_rllib_env import PredPreyGrass
from predpreygrass.rllib.sexual_reproduction.config.config_env_sexual_reproduction import config_env
from predpreygrass.rllib.sexual_reproduction.utils.episode_return_callback import EpisodeReturn
from predpreygrass.rllib.sexual_reproduction.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.sexual_reproduction.config.config_ppo_gpu_sexual_reproduction import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.sexual_reproduction.config.config_ppo_cpu_sexual_reproduction import config_ppo
    else:
