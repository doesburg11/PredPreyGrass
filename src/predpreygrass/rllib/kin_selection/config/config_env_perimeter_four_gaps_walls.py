config_env = {
    ...
    # Keep type_1 active; type_2 disabled by default in this layout
    "type_1_action_range": 3,
    "type_2_action_range": 0,
    # Rewards (direct reproduction rewards are overridden by lineage config when enabled)
    ...
    # Learning agents (type_2 disabled by default for this layout)
    ...
    # Mask dynamic obs channels by LOS and append visibility channel for learning signal
    "mask_observation_with_visibility": True,
    "include_visibility_channel": True,
    # Restrict movement to clear-LOS cells and forbid corner cutting
    ...
    # --- Wall placement ---
    # Manual wall layout: centered 12x12 square (side=12) with 2-cell opening on each side.
