...
from predpreygrass.rllib.v3_0.utils.networks import build_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.v3_0.config.config_ppo_gpu_network_tuning import config_ppo
    elif num_cpus == 8:
