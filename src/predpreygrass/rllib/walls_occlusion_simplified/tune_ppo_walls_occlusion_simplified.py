...
"""
from predpreygrass.rllib.walls_occlusion_simplified.predpreygrass_rllib_env_simplified import PredPreyGrass
from predpreygrass.rllib.walls_occlusion_simplified.config.config_env_walls_occlusion_simplified import config_env
from predpreygrass.rllib.walls_occlusion_simplified.utils.episode_return_callback import EpisodeReturn
from predpreygrass.rllib.walls_occlusion_simplified.utils.networks import build_multi_module_spec
...
def get_config_ppo():
    ...
    if num_cpus == 32:
        from predpreygrass.rllib.walls_occlusion_simplified.config.config_ppo_gpu_walls_oclussion_simplified import config_ppo
    elif num_cpus == 8:
        from predpreygrass.rllib.walls_occlusion_simplified.config.config_ppo_cpu_walls_oclussion_simplified import config_ppo
    else:
...
if __name__ == "__main__":
    ...
    experiment_name = f"PPO_LOSS_PER_MOVE_STEP_ZERO_{timestamp}"
