...
env_kwargs = dict(
    ...
    obs_range_prey=9,
    energy_gain_per_step_predator=-0.15, # metabolism rate Predator 3x of Prey
    ...
    regrow_grass=True,
    prey_creation_energy_threshold=10, # double the initial energy of prey
    predator_creation_energy_threshold=36, # double the initial energy of predator
    cell_scale=40,
    x_pygame_window=0,
    y_pygame_window=0,
