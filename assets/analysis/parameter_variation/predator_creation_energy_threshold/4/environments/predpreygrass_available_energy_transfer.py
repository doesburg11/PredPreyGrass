...
class PredPreyGrass:
    ...
    def reset(self):
        ...
        self.total_energy_learning_agents = self.total_energy_predator + self.total_energy_prey
        ...
        self.total_energy_learning_agents = self.total_energy_predator + self.total_energy_prey
        self.total_energy_learning_agents_list.insert(self.n_aec_cycles, self.total_energy_learning_agents)
